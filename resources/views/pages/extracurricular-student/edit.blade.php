    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                @endif
                    <form action="{{route('extracurricular-student.update', $siswa_ekskul->id)}}" method="post" class="px-4 py-4">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tahun_bergabung" name="tahun_bergabung" value="{{ $siswa_ekskul->tahun_bergabung }}">
                        </div>
